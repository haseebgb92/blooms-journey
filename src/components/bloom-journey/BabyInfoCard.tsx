  ...
  return (
    <Card className="bg-gradient-to-br from-pink-50 to-purple-50 border-2 border-pink-200 shadow-lg hover:shadow-primary/10 transition-shadow duration-300">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-1">
        <CardTitle className="text-sm font-medium font-headline text-pink-800">
          {babyInfo.babyName ? `${babyInfo.babyName}'s Progress` : 'Baby Progress'}
        </CardTitle>
      ...
      <CardContent className="pt-0 pb-3">
        ...
        {/* Approximate Days */}
        {babyInfo.dueDate && (
          <div className="mb-2 p-1.5 bg-white rounded-lg border border-pink-200">
        ...
        <div className="space-y-1">
          <Button
            ...
            className="w-full flex items-center justify-between text-pink-700 hover:bg-pink-50 h-6 text-xs"
          >
          ...
          {isExpanded && (
            <div className="space-y-1 pt-1 border-t border-pink-200">
              {/* Development Info */}
              ...
              {weekData.momSymptoms && weekData.momSymptoms.length > 0 && (
                <div className="p-1.5 bg-gradient-to-r from-pink-5 to-pink-10 rounded-lg border border-pink-200">
                  <div className="flex items-center gap-1 mb-1">
                    <HeartIcon className="h-2.5 w-2.5 text-pink-500" />
